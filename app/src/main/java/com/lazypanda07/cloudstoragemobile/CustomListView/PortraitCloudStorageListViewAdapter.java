...
public class PortraitCloudStorageListViewAdapter extends BaseAdapter
{
	private ArrayList<FileData> data;
	private LayoutInflater inflater;

	public PortraitCloudStorageListViewAdapter(Context context, ArrayList<FileData> data)
	{
		this.data = data;
